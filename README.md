...
When reviewing the data I paid close attention to the number of reviews and the reviews per month. 
The airbnbs with low minimum night requirements tend to have a lot more business except for a few outlier. 
The minimum night requirements and the number of reviews had a strong correlation and comparing it to the other data there was no other correlaion.
